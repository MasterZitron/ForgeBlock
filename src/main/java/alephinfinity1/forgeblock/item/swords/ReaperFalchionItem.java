...
public class ReaperFalchionItem extends FBSwordItem{


    public ReaperFalchionItem(Properties props, FBTier tier, double attackDamageIn, double strengthIn, double critChanceIn,
			double critDamageIn) {
